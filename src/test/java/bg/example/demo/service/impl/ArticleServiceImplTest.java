...
import bg.example.demo.model.entity.ArticleEntity;
...
import bg.example.demo.service.ArticleServiceImpl;
...
public class ArticleServiceImplTest {
    ...
    public void testFindAll() {
        List<ArticleViewModel> allModels= serviceToTest.findAllArticle();
