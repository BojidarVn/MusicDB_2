...
import bg.example.demo.model.entity.UserRoleEntity;
import bg.example.demo.model.entity.enums.UserRole;
import bg.example.demo.model.service.UserRegistrationServiceModel;
import bg.example.demo.repository.UserRepository;
import bg.example.demo.repository.UserRoleRepository;
